...
# Russian translation
rst2html --stylesheet=zope3.css izca-ru.txt > zca-ru.html 
rst2latex --use-latex-docinfo --use-latex-toc --stylesheet=style.tex --documentclass=book --use-latex-footnotes --output-encoding=utf8 --documentoptions=10pt,a4paper,english,russian --font-encoding=T2A izca-ru.txt > zca-ru.tex
pdflatex zca-ru.tex
pdflatex zca-ru.tex
